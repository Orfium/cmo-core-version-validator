...
GITHUB_ACCESS_TOKEN = os.getenv("INPUT_GITHUB_ACCESS_TOKEN")
CURRENT_REPO = os.getenv("INPUT_CURRENT_REPO")
CURRENT_HASH = os.getenv("INPUT_CURRENT_HASH")
CURRENT_REQUIREMENTS_FILE = os.getenv("INPUT_CURRENT_REQUIREMENTS_FILE")
CURRENT_REQUIREMENTS_FILE_FORMAT = os.getenv(
    "INPUT_CURRENT_REQUIREMENTS_FILE_FORMAT"
)
REF_REPO = os.getenv("INPUT_REF_REPO")
REF_HASH = os.getenv("INPUT_REF_HASH")
REF_REQUIREMENTS_FILE = os.getenv("INPUT_REF_REQUIREMENTS_FILE")
REF_REQUIREMENTS_FILE_FORMAT = os.getenv("INPUT_REF_REQUIREMENTS_FILE_FORMAT")
